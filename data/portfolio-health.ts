...
export const releaseRecords: Release[] = [
  ...
  { id: "REL000106", changeId: "CHG0038184", day: 22, month: "2026-07", title: "Entitlement DB migration — rescheduled", time: "10:30 PM", window: "10:30 PM–1:30 AM CT", serviceId: "svc-002", owner: "D. Kim", risk: "High", type: "Normal", status: "Scheduled", environment: "Production", summary: "Rescheduled window for the carried-over entitlement service database migration.", conditions: ["Carried-over change re-approved", "Data reconciliation signed", "Failback tested"] },
  ...
  { id: "REL000110", changeId: "CHG0038538", day: 4, month: "2025-08", title: "Identity datastore migration", time: "10:00 PM", window: "10:00 PM–1:00 AM CT", serviceId: "svc-002", owner: "D. Kim", risk: "High", type: "Normal", status: "Complete", environment: "Production", summary: "Migrate identity profile data to the resilient multi-region datastore.", conditions: ["Data reconciliation signed", "Failback tested", "Executive notification drafted"] },
  ...
  { id: "REL000112", changeId: "CHG0038619", day: 18, month: "2025-08", title: "Settlement resilience test", time: "11:30 PM", window: "11:30 PM–1:30 AM CT", serviceId: "svc-003", owner: "J. Wu", risk: "High", type: "Normal", status: "Complete", environment: "Production", summary: "Run controlled node-failure validation before peak processing season.", conditions: ["CAB approval complete", "Operations bridge booked", "Recovery checkpoint documented"] },
  ...
  { id: "REL000117", changeId: "CHG0038864", day: 20, month: "2025-10", title: "Change-freeze readiness release", time: "8:00 PM", window: "8:00 PM–11:00 PM CT", serviceId: "svc-006", owner: "R. Chen", risk: "Moderate", type: "Normal", status: "Complete", environment: "Production", summary: "Complete platform tooling updates ahead of the year-end change freeze.", conditions: ["Freeze exception list reviewed", "Toolchain health green", "Support coverage confirmed"] },
  ...
  { id: "REL000125", changeId: "CHG0039294", day: 7, month: "2026-03", title: "Trading platform release 27.3", time: "8:00 PM", window: "8:00 PM–11:30 PM CT", serviceId: "svc-001", owner: "M. Rivera", risk: "High", type: "Normal", status: "Complete", environment: "Production", summary: "Deliver the March trading release with routing and telemetry enhancements.", conditions: ["Trading certification complete", "Market-open rollback plan", "Business bridge staffed"] },
  ...
  { id: "REL000127", changeId: "CHG0039406", day: 4, month: "2026-04", title: "Multi-region traffic cutover", time: "9:30 PM", window: "9:30 PM–1:00 AM CT", serviceId: "svc-004", owner: "T. Green", risk: "High", type: "Normal", status: "Complete", environment: "Production", summary: "Shift advisor traffic to the active-active regional architecture.", conditions: ["Regional readiness green", "NFR sign-off complete", "Failback under 20 minutes"] },
  ...
  { id: "REL000129", changeId: "CHG0039524", day: 9, month: "2026-05", title: "Observability standard rollout", time: "8:00 PM", window: "8:00 PM–10:00 PM CT", serviceId: "svc-005", owner: "S. Brooks", risk: "Moderate", type: "Normal", status: "Complete", environment: "Production", summary: "Complete mandatory service-level telemetry and alerting coverage.", conditions: ["Coverage threshold met", "Alert routing tested", "Runbooks linked"] },
